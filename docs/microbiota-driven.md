...
Microglia cells have been extracted from 26 mices given:
- 2 microbiota states: Conventional (SPF) and Germ free (GF)
- 2 ages: Young (8 weeks), Old (104 weeks)
- 1 sex: Male 

Microbiota | Age | Number of samples
--- | --- | --- | --
GF | Old | Male | 5
GF | Young | Male | 4
SPF | Old | Male | 13
...
- microbiota effect (GF vs SPF) for the both ages
- age effect (Old vs Young) for both microbiota
